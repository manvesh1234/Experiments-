...
// // // // title.textContent = "welcome to creva";
...
// // // // // 4. Check whether dark exists
// // // // console.log(box.classList.contains("dark"));

// // // function solve4Queens() {
// // //     const N = 4;
// // //     // Initialize an empty 4x4 chessboard filled with '.'
// // //     const board = Array.from({ length: N }, () => Array(N).fill('.'));
// // //     const solutions = [];

// // //     // Helper function to check if it's safe to place a queen at board[row][col]
// // //     function isSafe(row, col) {
// // //         // Check this column for upper rows
// // //         for (let i = 0; i < row; i++) {
...
// // //         // Base case: If all 4 queens are safely placed, record the solution
// // //         if (row === N) {
...
// // //                 // Backtrack: Remove the queen if it didn't lead to a complete solution
// // //                 board[row][col] = '.';
// // //             }
// // //         }
// // //     }

// // //     // Start the recursion from the first row (index 0)
// // //     backtrack(0);
// // //     return solutions;
// // // }

// // // // Execute and print the results
// // // const allSolutions = solve4Queens();
...
// // h2.textContent = "Creta";

// // let p = document.createElement("p");
// // p.textContent = "learning platform";
